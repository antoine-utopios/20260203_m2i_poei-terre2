...
* On va créer le Dockerfile dans `./website/Dockerfile`
...
* Dans un terminal ouvert dans `./website/Dockerfile`:

```bash
docker build -t exo-07-image .

docker run -p 8080:80 -d --name exo-07-test exo-07-image
